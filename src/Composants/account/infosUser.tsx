          ...
          <div className="flex flex-col items-center text-neutral-900 w-full">
            <div className="mb-10 text-center">
              ...
              <div className="mt-10">
                ...
                <div>
                  {!emailVerified && (
                    <div className="flex flex-col md:flex-row justify-center items-center mt-6 space-y-3 md:space-y-0 md:space-x-3">
            ...
            >
              {!isEntreprise && (
                <FadeIn className="flex flex-col text-secondary bg-secondary m-5 border rounded-lg shadow-lg p-6 w-full sm:w-auto">
