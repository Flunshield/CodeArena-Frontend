        ...
        <div id="PricingSection" className="container mx-auto py-8">
            ...
            {lastCommande &&
                <div className="bg-[#D63864] rounded-lg border-l-4 border-red-500 text-tertiari p-4 m-10 mb-0" role="alert">
                    ...
                    <p>Un plan est déja actif, vous ne npouvez donc pas en prendre un nouveau plan sans annuler le précédent.</p>
                </div>
            }
                    ...
                    >
                        ...
                        <div>
                            ...
                            {authContext.connected && infos.data.groups.roles === GROUPS.USER &&
                                <Button type="submit" id={plan.title} onClick={() => handleCheckoutBtn(plan.url ?? "", plan.idApi ?? "", plan.typePayment ?? "")}
