        ...
        <header>
            <div className="absolute top-0 left-0 w-full h-full">
                ...
                <div className="flex start-0 justify-between">
                    ...
                    {isConnected &&
                        <div className="flex items-baseline">
                            <Button type="button" id="signOut" className="border-1 text-white text-1xl m-3 border-2 border-white rounded-md p-1" onClick={handleClickSingOut}> {t('disonnect')} </Button>
                        </div>
                    }
                </div>
            </div>
