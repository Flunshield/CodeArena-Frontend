...
import {CINQUANTE, CODE_LANGUAGES_FAVORITES, DIX, VINGT_CINQ} from "../constantes/constantes.ts"; // Assurez-vous d'importer vos constantes correctement
...
const SearchBar = ({
    ...
    return (
        <div
            className="flex items-center max-lg:flex-col justify-center p-2 shadow-md bg-gray-200 dark:bg-gray-800 dark:text-gray-300 rounded-lg mb-4">
            {isEntreprise && (
