...
const ListItem: React.FC<ListItemProps> = ({ icon, id, text, classNameSvg }) => {
    return (
        <li className="flex flex-row mb-2 lg:mr-0 items-center">
            ...
            <p id={id} className="bg-tertiari text-secondary p-2 rounded-md w-60 break-all ml-2 mr-10 shadow-lg transition duration-300 ease-in-out transform hover:scale-105">
                {text}
            </p>
        </li>
    );
